...
namespace Substrate
{
    ...
    public class Level : INbtObject<Level>, ICopyable<Level>
    {
        private static SchemaNodeCompound _schema = new SchemaNodeCompound()
        {
            new SchemaNodeCompound("Data")
            {
                ...
                new SchemaNodeCompound("CustomBossEvents", SchemaOptions.OPTIONAL) //
                {
                    ...
                    {
                        new SchemaNodeScaler("Players", TagType.TAG_LIST, SchemaOptions.OPTIONAL), //
                        new SchemaNodeScaler("Color", TagType.TAG_STRING, SchemaOptions.OPTIONAL), //
                        new SchemaNodeScaler("CreateWorldFog", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                        new SchemaNodeScaler("DarkenScreen", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                        new SchemaNodeScaler("Max", TagType.TAG_INT, SchemaOptions.OPTIONAL), //
                        new SchemaNodeScaler("Value", TagType.TAG_INT, SchemaOptions.OPTIONAL), //
                        new SchemaNodeScaler("Name", TagType.TAG_STRING, SchemaOptions.OPTIONAL), //
                        new SchemaNodeScaler("Overlay", TagType.TAG_STRING, SchemaOptions.OPTIONAL), //
                        new SchemaNodeScaler("PlayBossMusic", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                        new SchemaNodeScaler("Visible", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                    },
                },
                new SchemaNodeCompound("DataPacks", SchemaOptions.OPTIONAL) //
                {
                    new SchemaNodeScaler("Disabled", TagType.TAG_LIST, SchemaOptions.OPTIONAL), //
                    new SchemaNodeScaler("Enabled", TagType.TAG_LIST, SchemaOptions.OPTIONAL), //
                },
                new SchemaNodeScaler("DataVersion", TagType.TAG_INT, SchemaOptions.OPTIONAL), //
                ...
                new SchemaNodeCompound("DimensionData", SchemaOptions.OPTIONAL), //
                {
                    new SchemaNodeCompound("1", SchemaOptions.OPTIONAL)
                    {
                        new SchemaNodeCompound("DragonFight", SchemaOptions.OPTIONAL)
                        {
                            ...
                            {
                                new SchemaNodeScaler("X", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                                new SchemaNodeScaler("Y", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                                new SchemaNodeScaler("Z", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                            },
                            new SchemaNodeScaler("Gateways", TagType.TAG_LIST, SchemaOptions.OPTIONAL), //
                            new SchemaNodeScaler("DragonKilled", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                            new SchemaNodeScaler("DragonUUIDLeast", TagType.TAG_LONG, SchemaOptions.OPTIONAL), //
                            new SchemaNodeScaler("DragonUUIDMost", TagType.TAG_LONG, SchemaOptions.OPTIONAL), //
                            new SchemaNodeScaler("PreviouslyKilled", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                        }
                    }
                },
                new SchemaNodeCompound("GameRules", SchemaOptions.OPTIONAL) //This might need to be fixed
                {
                ...
                {
                    new SchemaNodeScaler("bonus_chest", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                    new SchemaNodeScaler("seed", TagType.TAG_LONG, SchemaOptions.OPTIONAL), //
                    new SchemaNodeScaler("generate_features", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                    new SchemaNodeCompound("dimensions", SchemaOptions.OPTIONAL)
                    {
                        new SchemaNodeCompound("Dimension ID", SchemaOptions.OPTIONAL) //
                    }
                },
                new SchemaNodeScaler("GameType", TagType.TAG_INT, SchemaOptions.OPTIONAL),
                //Used in 1.15 and below
                ...
                {
                    new SchemaNodeScaler("Id", TagType.TAG_INT, SchemaOptions.OPTIONAL), //
                    new SchemaNodeScaler("Name", TagType.TAG_STRING, SchemaOptions.OPTIONAL), //
                    new SchemaNodeScaler("Series", TagType.TAG_STRING, SchemaOptions.OPTIONAL), //
                    new SchemaNodeScaler("Snapshot", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
                },
                new SchemaNodeScaler("WanderingTraderId", TagType.TAG_LONG_ARRAY, SchemaOptions.OPTIONAL), //
                new SchemaNodeScaler("WanderingTradeSpawnChance", TagType.TAG_INT, SchemaOptions.OPTIONAL), //
                new SchemaNodeScaler("WanderingTraderSpawnDelay", TagType.TAG_INT, SchemaOptions.OPTIONAL), //
                new SchemaNodeScaler("WasModded", TagType.TAG_BYTE, SchemaOptions.OPTIONAL), //
            },
        };
        ...
        public virtual Level LoadTree (TagNode tree)
        {
            ...
            if (dtree == null) {
                Console.WriteLine("Found null tree");
                return null;
            }
