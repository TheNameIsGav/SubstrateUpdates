...
namespace Substrate
{
    ...
    public class AnvilWorld : NbtWorld
    {
        ...
        {
            Console.WriteLine("Found Chunk Manager in AnvilWorld");
        ...
        private void OpenDimension (string dim)
        {
            ...
            Console.WriteLine("Path at: {0}", path);
        ...
        internal static void OnResolveOpen (object sender, OpenWorldEventArgs e)
        {
            try {
                ...
                if (!Directory.Exists(regPath)) {
                    Console.WriteLine("Filed on Reg Paht");
                    return;
                }

                Console.WriteLine(world.Level.Version);
